    ...
    users: {
      _id: (val1: number) => {
        ...
        return {
          ...
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods4['get']['resBody'], BasicHeaders, Methods4['get']['status']>(prefix, prefix1, GET, option)
              .json()
              .then((r) => r.body),
          put: (option: { body: Methods4['put']['reqBody']; config?: T | undefined }) =>
            fetch<Methods4['put']['resBody'], BasicHeaders, Methods4['put']['status']>(
              prefix,
              prefix1,
              PUT,
              option,
          ...
          patch: (option: { body: Methods4['patch']['reqBody']; config?: T | undefined }) =>
            fetch<Methods4['patch']['resBody'], BasicHeaders, Methods4['patch']['status']>(
              prefix,
              prefix1,
              PATCH,
              option,
